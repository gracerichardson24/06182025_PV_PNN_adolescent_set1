...
FluoData = read.csv("DATAFLUO/C2_merged_data.csv")
...
# Save
ggsave("Intensity_plot.png", plot = intensity, width = 2, height = 4, dpi = 300)
...
Int_Den_plot <- ggplot() +
  ...
  geom_jitter(data = FluoData, aes(x = Group, y = IntDen, color = animal),
              width = 0.2, size = 0.5, alpha = 0.6) +
  theme_minimal() +
  xlab(" ") +
...
# Save
ggsave("Intensity_plot_Intden.png", plot = Int_Den_plot, width = 2, height = 4, dpi = 300)
